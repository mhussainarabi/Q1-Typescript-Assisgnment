...
["Ali khan","Babar Azam","Muhammad Haris","Shaheen Afridi","Fakhar Zaman","Iftikhar Chacha"]
const new_user:string[]= ["Muhammad Haris","Shadab khan","Haris Rauf","Fakhar Zaman","wasim JR"]

function checkuserName(current_user:string[],new_user:string[]):void{
